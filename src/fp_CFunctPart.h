...
public:
    ...
    CFunctPart() : a0(0.), a1(0.), a2(0.), lBorder(0.), rBorder(0.), rac1(0.), rac2(0.), racStatus(0), origine(0) {}

    ~CFunctPart() {}

    CFunctPart(double a0_, double a1_, double a2_, double lBorder_, double rBorder_, int origine_)
        : a0(a0_), a1(a1_), a2(a2_), lBorder(lBorder_), rBorder(rBorder_), rac1(0.), rac2(0.), racStatus(0),
          origine(origine_) {}

    CFunctPart(double lBorder_, double rBorder_)
        : a0(0.), a1(0.), a2(0.), lBorder(lBorder_), rBorder(rBorder_), rac1(0.), rac2(0.), racStatus(0), origine(-1) {}

    CFunctPart(double a0_, double a1_, double a2_, double lBorder_, double rBorder_, double rac1_, double rac2_,
               int origine_)
        : a0(a0_), a1(a1_), a2(a2_), lBorder(lBorder_), rBorder(rBorder_), rac1(rac1_), rac2(rac2_), racStatus(0),
          origine(origine_) {}
